...
/* harmony import */ var _functions_spollers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/spollers */ "./src/js/functions/spollers.js");
...
(0,_functions_spollers__WEBPACK_IMPORTED_MODULE_3__["default"])();
...
function initSliders() {
  if (document.querySelector('.header-main__banners')) {
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.header-main__banners', {
      observer: true,
      observeParents: true,
      autoHeight: true,
      slidesPerView: 1.15,
  ...
  if (document.querySelector('.request-catalog__banners-container')) {
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.request-catalog__banners-container', {
      observer: true,
      observeParents: true,
      slidesPerView: 1.15,
      spaceBetween: 16,
